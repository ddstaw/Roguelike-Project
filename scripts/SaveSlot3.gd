...
func _on_Button_pressed():
	...
	var basemapinfo_path = "user://saves/save3/world/basemapinfo3.json"
	var basemapdata_path = "user://saves/save3/world/basemapdata3.json"
	var char_active_path = "user://saves/save3/world/char_active3.json"
	var worldmap_basemapinfo_path = "user://saves/save3/world/worldmap_basemapinfo3.json"
