...
@onready var sort_bar: HBoxContainer     = $"/root/Inventory_LocalPlay/SortBar"
@onready var inv_scroll: ScrollContainer = $"/root/Inventory_LocalPlay/GridFrame/InvScroll"
